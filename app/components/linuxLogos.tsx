...
export default function LinuxLogos() {
    ...
    return (
        <div className="w-full flex justify-between items-center overflow-x-scroll">
            ...
            <Image className="grayscale-[30] hover:grayscale-0" width={30} height={30} alt="لوگو لینوکس" src={'/images/logos/fedora.png'}/>
            <Image className="grayscale-[30] hover:grayscale-0" width={30} height={30} alt="لوگو لینوکس" src={'/images/logos/manjaro.png'}/>
            <Image className="grayscale-[30] hover:grayscale-0" width={30} height={30} alt="لوگو لینوکس" src={'/images/logos/suse.png'}/>
